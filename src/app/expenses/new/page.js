...
export default function NewExpensePage() {
  ...
  const { createExpense, uploadImage, loading } = useExpenses();
  ...
  const onSubmit = async (data) => {
    try {
      ...
      // Create expense (without participants)
      const expenseData = {
          ...
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              ...
              <p className="mt-1 text-sm text-gray-600">
                Fill in the details to add a new expense. You can also upload an image of the receipt.
              </p>
            </div>
          </div>
